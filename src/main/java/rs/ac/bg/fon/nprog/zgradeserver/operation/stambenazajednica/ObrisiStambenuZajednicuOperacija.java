 ...
 * @author Sara
 */
public class ObrisiStambenuZajednicuOperacija extends AbstractGenericOperation{

    @Override
    protected void preconditions(Object param) throws Exception {
        if (param == null || !(param instanceof StambenaZajednica)) {
            throw new Exception("Sistem ne moze da obrise stambenu zajednicu");
        }
    }
    ...
    protected void executeOperation(Object param) throws Exception {
        try {
            repository.delete((StambenaZajednica) param);
        }catch(Exception e){
            throw new Exception("Sistem ne moze da obrise stambenu zajednicu");
        }
    }
